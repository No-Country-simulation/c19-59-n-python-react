...
export const CustomerHomePage = () => {
  return (
    <div className="h-screen py-5 flex flex-col">
      ...
      <section className="flex flex-col items-center justify-evenly gap-y-3 h-screen">
        <div>
          <Image
            isBlurred
            src={gatito}
        ...
        <div className="flex flex-wrap w-64 gap-x-2 gap-y-3 justify-center mt-6 relative">
          <HomePageButton 
            disabled={true} 
            onClick={() => {}} 
            className='w-[124px] h-[87px] bg-menuColor-3 rounded-xl font-manrope text-[11px] text-left pl-3 bg-opacity-70 relative'
            imgPath={MedicalImg}
            >
          ...
          <HomePageButton 
            disabled={true} 
            onClick={() => {}} 
            className='w-[124px] h-[87px] bg-menuColor-4 rounded-xl font-manrope text-[11px] text-left pl-3 bg-opacity-70 relative'
          ...
          <HomePageButton 
            disabled={true} 
            onClick={() => {}} 
            className='w-[124px] h-[87px] bg-menuColor-2 rounded-xl font-manrope text-[11px] text-left pl-3 bg-opacity-70 relative'
            imgPath={DocumentImg}
            >
          ...
          <HomePageButton 
            disabled={true} 
            onClick={() => {}} 
            className='w-[124px] h-[87px] bg-menuColor-1 rounded-xl font-manrope text-[11px] text-left pl-3 bg-opacity-70 relative'
            imgPath={VitalImg}
            >
        ...
        <div className="flex gap-x-4 text-center font-manrope text-[13px] font-semibold mb-10 z-10">
